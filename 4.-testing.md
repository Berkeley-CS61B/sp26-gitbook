...
While the single test above wasn't a ton of work, writing a suite of such _ad hoc_ tests would be very tedious, as it would entail writing a bunch of different loops and print statements. In the next section, we'll see how the Google Truth library saves us a lot of work.

#### Truth Testing <a href="#truth-testing" id="truth-testing"></a>
